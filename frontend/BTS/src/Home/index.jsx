  ...
  return (
    <div className="text1"><FaBus />pmpml
      ...
      <div className="homeBox">
        ...
        <div className="search-bar-container">
          <div className="searchbar">
            <input type="text" value={toValue} onChange={onToChange} />
          </div>
        </div>
        <div className="dropdown">
      ...
      <div className="pass">
        <button className="pass-btn"><IoTicket size={20} color="#3bab40"/><br />Daily<br /> Pass</button>
        <button className="pass-btn"><IoTicket size={20} color="#3bab40"/><br />Monthly<br /> Pass</button>
      </div>
